...
import com.hosazz.flightscalendar.listeners.YearViewClickListeners;
...
public class YearView extends LinearLayout implements MonthViewClickListeners {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        jan = view.findViewById(R.id.mv_year_view_jan);
        feb = view.findViewById(R.id.mv_year_view_feb);
        march = view.findViewById(R.id.mv_year_view_march);
        april = view.findViewById(R.id.mv_year_view_april);
        may = view.findViewById(R.id.mv_year_view_may);
        june = view.findViewById(R.id.mv_year_view_jun);
        july = view.findViewById(R.id.mv_year_view_july);
        aug = view.findViewById(R.id.mv_year_view_aug);
        sept = view.findViewById(R.id.mv_year_view_sept);
        oct = view.findViewById(R.id.mv_year_view_oct);
        nov = view.findViewById(R.id.mv_year_view_nov);
        dec = view.findViewById(R.id.mv_year_view_dec);

        tvDisplayYear = view.findViewById(R.id.tv_year_view_name);

        ivLeftArrow = view.findViewById(R.id.iv_year_view_left);
        ivRightArrow = view.findViewById(R.id.iv_year_view_right);

        headerLayout = view.findViewById(R.id.rl_year_view_header);
        calendarLayout = view.findViewById(R.id.sv_year_view_calendar_background);
